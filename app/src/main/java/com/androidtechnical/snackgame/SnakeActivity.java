...
public class SnakeActivity extends SurfaceView implements Runnable {
...
// Is the game currently playing?
    ...
    public SnakeActivity(Context context, Point size) {
        super(context);
...
@Override
    ...
    public void draw() {
        ...
        if (surfaceHolder.getSurface().isValid()) {
            ...
            canvas.drawColor(Color.argb(255, 136, 226, 45));

            // Set the color of the paint to draw the snake white
            paint.setColor(Color.argb(255, 22, 86, 36));
            ...
            paint.setColor(Color.argb(255, 138, 145, 140));
